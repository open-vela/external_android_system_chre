...
#ifndef CHRE_PLATFORM_NUTTX_LOG_H_
#define CHRE_PLATFORM_NUTTX_LOG_H_
...
#define LOGE(fmt, ...) \
  CHRE_NUTTX_LOG(CHRE_LOG_ERROR, "E", "91", fmt, ##__VA_ARGS__)
#define LOGW(fmt, ...) \
  CHRE_NUTTX_LOG(CHRE_LOG_WARN, "W", "93", fmt, ##__VA_ARGS__)
#define LOGI(fmt, ...) \
  CHRE_NUTTX_LOG(CHRE_LOG_INFO, "I", "96", fmt, ##__VA_ARGS__)
#define LOGD(fmt, ...) \
  CHRE_NUTTX_LOG(CHRE_LOG_DEBUG, "D", "97", fmt, ##__VA_ARGS__)

#endif  // CHRE_PLATFORM_NUTTX_LOG_H_

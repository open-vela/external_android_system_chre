...
#ifndef CHRE_PLATFORM_NUTTX_TASK_UTIL_TASK_MANAGER_H_
#define CHRE_PLATFORM_NUTTX_TASK_UTIL_TASK_MANAGER_H_
...
#endif  // CHRE_PLATFORM_NUTTX_TASK_UTIL_TASK_MANAGER_H_
